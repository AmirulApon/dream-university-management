...
if ( ! empty( $_GET ) && isset( $_GET['_wpnonce'] ) ) {
	if ( ! wp_verify_nonce( sanitize_text_field( wp_unslash( $_GET['_wpnonce'] ) ), 'dreaunma-teachers-view' ) ) {
		wp_die( esc_html__( 'Security check failed.', 'dream-university-management' ) );
	}
}
...
if ( $action === 'add' || $action === 'edit' ) {
	...
	<div class="wrap">
		...
		<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
			<?php wp_nonce_field( $action === 'add' ? 'dreaunma_add_teacher' : 'dreaunma_edit_teacher' ); ?>
			<input type="hidden" name="action" value="<?php echo $action === 'add' ? 'dreaunma_add_teacher' : 'dreaunma_edit_teacher'; ?>">
			<?php if ( $action === 'edit' ) : ?>
			...
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=dreaunma-teachers' ) ); ?>" class="button"><?php esc_html_e( 'Cancel', 'dream-university-management' ); ?></a>
		</form>
	</div>
	<?php
} else {
	...
	$teachers = DREAUNMA_Teacher::get_all( array( 
		'search' => $search,
	...
	<div class="wrap">
		...
		<a href="<?php echo esc_url( admin_url( 'admin.php?page=dreaunma-teachers&action=add' ) ); ?>" class="page-title-action"><?php esc_html_e( 'Add New', 'dream-university-management' ); ?></a>
			...
			<form method="get" action="">
				...
				<p class="search-box">
					...
					<?php if ( ! empty( $search ) || $status_filter !== 'all' ) : ?>
						<a href="<?php echo esc_url( admin_url( 'admin.php?page=dreaunma-teachers' ) ); ?>" class="button"><?php esc_html_e( 'Clear', 'dream-university-management' ); ?></a>
					<?php endif; ?>
				</p>
			</form>
		</div>
				...
				<?php else : ?>
					<?php foreach ( $teachers as $teacher ) : ?>
						...
						if ( ! empty( $teacher->faculty_id ) ) {
							$faculty = DREAUNMA_Faculty::get( $teacher->faculty_id );
							$faculty_name = $faculty ? $faculty->faculty_name : '';
						}
						if ( ! empty( $teacher->department_id ) ) {
							$department = DREAUNMA_Department::get( $teacher->department_id );
						...
						<tr>
							...
							<td>
								<span class="dreaunma-status <?php echo esc_attr( $teacher->status ); ?>">
									<?php echo esc_html( ucfirst( $teacher->status ) ); ?>
								</span>
							</td>
							<td>
								<a href="<?php echo esc_url( admin_url( 'admin.php?page=dreaunma-teachers&action=edit&id=' . $teacher->id ) ); ?>"><?php esc_html_e( 'Edit', 'dream-university-management' ); ?></a> |
