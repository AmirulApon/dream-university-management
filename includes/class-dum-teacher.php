...
class DUM_Teacher {
	...
	public function handle_add_teacher() {
		...
		if ( $result ) {
			wp_redirect( admin_url( 'admin.php?page=dum-teachers&message=added' ) );
		} else {
			wp_redirect( admin_url( 'admin.php?page=dum-teachers&message=error' ) );
		}
		exit;
	}
	...
	public function handle_edit_teacher() {
		...
		if ( $result !== false ) {
			wp_redirect( admin_url( 'admin.php?page=dum-teachers&message=updated' ) );
		} else {
			wp_redirect( admin_url( 'admin.php?page=dum-teachers&message=error' ) );
		}
		exit;
	...
	public function handle_delete_teacher() {
		...
		if ( $result ) {
			wp_redirect( admin_url( 'admin.php?page=dum-teachers&message=deleted' ) );
		} else {
			wp_redirect( admin_url( 'admin.php?page=dum-teachers&message=error' ) );
		}
		exit;
